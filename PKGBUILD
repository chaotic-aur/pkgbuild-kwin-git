...
license=(LGPL)
depends=(kscreenlocker-git xcb-util-cursor plasma-framework-git kcmutils-git breeze-git qt5-sensors qt5-script pipewire libqaccessibilityclient-git libdrm lcms2 wayland-protocols-git plasma-wayland-protocols-git)
